    ...
    <div className="video-player">
      <div className="video-wrapper">
        ...
        <div className="controls">
          <div className="controls-left">
            <span className="time-elapsed">10:15</span>
            <input type="range" min="0" max="100" defaultValue="70" className="volume-slider" />
          </div>
          <div className="controls-right">
            <svg className="airplay" width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className="captions" width="21" height="15" viewBox="0 0 21 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className="fullscreen" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="time-remaining">1:02:15</span>
          </div>
      ...
      <button className="playpause">
        <svg width="50" height="21" viewBox="0 0 50 21" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M1 18.322V2.83726C1 2.04494 1.87753 1.56731 2.54291 1.99748L15.5827 10.4276C16.2208 10.8401 16.1839 11.7853 15.5056 12.1469L2.47584 19.2016C1.80955 19.562 1 19.0796 1 18.322Z" stroke="#333333" stroke-width="2" />
        </svg>
      </button>
    </div>
  );
